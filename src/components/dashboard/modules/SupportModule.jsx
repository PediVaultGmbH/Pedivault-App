    ...
    <div className="pv-page" style={{animation:'fadeUp .3s ease both'}}>
      ...
      <div style={{display:'flex',flexDirection:'column',gap:0,borderRadius:14,overflow:'hidden',boxShadow:'var(--shadow-card)',marginBottom:20}}>
        {[
          ...
          {icon:<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--rose)" strokeWidth="1.8" strokeLinecap="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>,                             label:'Privacy & Data',           sub:'DSGVO rights, data export, deletion',        legalHash:'privacy'},
          {icon:<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--rose)" strokeWidth="1.8" strokeLinecap="round"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>, label:'Subscription & Payments', sub:'Free plan · Upgrade to Premium €4.99/mo', badge:'FREE'},
          {icon:<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--rose)" strokeWidth="1.8" strokeLinecap="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>, label:'Terms of Use',          sub:'Usage rules and medical disclaimer',        legalHash:'terms'},
          {icon:<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--rose)" strokeWidth="1.8" strokeLinecap="round"><circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/></svg>,                       label:'About PediVault',          sub:'Version 1.0.0 · PediVault GmbH Berlin'},
        ].map((item,i,arr)=>(
          <div key={i}
            onClick={()=>{
        ...
        <div style={{display:'flex',alignItems:'flex-start',gap:12}}>
          ...
          <div style={{flex:1}}>
            ...
            <div style={{display:'flex',gap:10,flexWrap:'wrap'}}>
              {[{label:'Privacy Policy',hash:'privacy'},{label:'Terms of Use',hash:'terms'},{label:'DSGVO / GDPR',hash:'privacy'},{label:'FAQ',hash:'faq'},{label:'Impressum',hash:'imprint'}].map((l,i)=>(
