...
export function SignOutModal({open,onClose,onConfirm}) {
  return (
    <Modal open={open} onClose={onClose} maxWidth={360}>
      <div className="pv-mhdr" style={{borderBottom:'none',textAlign:'center',padding:'36px 28px 0'}}>
        ...
        <div style={{fontFamily:"'Playfair Display',serif",fontSize:'1.25rem',fontWeight:400,color:'var(--ink)',marginBottom:8}}>Sign out of PediVault?</div>
        <div style={{fontSize:'.57rem',fontWeight:300,color:'var(--ink-3)',lineHeight:1.75,marginBottom:6}}>
          All your child's health records are safely encrypted<br/>and will be waiting when you come back.<br/>
          <span style={{fontWeight:500,color:'var(--ink)'}}>See you soon, Lena 🌸</span>
        </div>
      </div>
